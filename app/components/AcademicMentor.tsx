...
const MentorCard = ({ mentor }: { mentor: Mentor }) => (
  <div className="flex flex-col items-center px-4">
    ...
    <div className="w-[60vw] max-w-[250px] md:w-[20vw] h-auto mt-2 overflow-hidden rounded-[50px] border-[#91DAAE] border-4">
      <Image
        src={mentor.imageSrc}
    ...
    <div className="relative mt-6">
      <div className="rounded-[50px] w-[300px] h-[86px] bg-gradient-to-b from-[#F37D12] to-[#FDE309] flex items-center p-4">
        <p className="text-sm text-center flex-grow">{mentor.title}</p>
...
export const AcademicMentor = () => {
  ...
  return (
    <div className="px-10 pb-10">
      <div className="text-center md:pt-[4rem] pt-[2rem] pb-[1rem] font-sans font-bold md:text-6xl text-3xl text-color-gradient drop-shadow-text">
