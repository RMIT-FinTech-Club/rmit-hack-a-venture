...
export const AboutUsSection = () => {
  return (
    <div className="items-center justify-center mx-auto w-fit max-md:px-[16px] max-md:mt-[40px] text-xl text-white font-medium text-md md:px-20 ">
      <Image
        src="/key-visual.png"
        width={2000}
        height={1000}
      ...
      />
      <div className="mt-[40px] md:text-justify">
      ...
      <div className="my-[16px] md:text-justify">
